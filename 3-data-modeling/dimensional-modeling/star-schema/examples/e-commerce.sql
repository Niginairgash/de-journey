...
create table fact_sales(
	...
	customer_fk		int 		not null references  dim_customer(customer_pk),
	product_fk		int			not null references dim_product(product_pk),
	date_pk			int 		not null references dim_date(date_pk),
	unit_price		numeric(12, 2)	not null,
