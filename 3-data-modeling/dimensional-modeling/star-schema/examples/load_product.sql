...
change as (
	select 
		p.product_id ,
		p.product_name ,
		s.suppliers_company_name ,
		s.suppliers_contact_name ,
		p.unit_price ,
		p.package,
    p.is_discontinued
  ...
  or dp.suppliers_company_name    is distinct from s.suppliers_company_name
  or dp.suppliers_contact_name    is distinct from s.suppliers_contact_name
...
select 
	product_id,	product_name, suppliers_company_name, suppliers_contact_name, unit_price, package, is_discontinued,
